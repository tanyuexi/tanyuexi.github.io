---
layout: post
title:  "Neural Networks for Machine Learning (2/3) - UofT [Course]"
author: Yuexi Tan
...
<img src="{{ "/images/20160331-CurvatureMatrices-300x294.png" | prepend: site.baseurl }}" id="Fig8.1-1">
...
<img src="{{ "/images/20160331-ConjugateGradient-200x176.png" | prepend: site.baseurl }}" id="Fig8.1-2">
...
<img src="{{ "/images/20160331-MultiplicativeConnection-800x647.png" | prepend: site.baseurl }}" id="Fig8.2-1">
...
<img src="{{ "/images/20160331-EsnExample-800x465.png" | prepend: site.baseurl }}" id="Fig8.3-1">
...
<img src="{{ "/images/20160331-LimitWeightSquare-500x352.png" | prepend: site.baseurl }}" id="Fig9.2-1">
...
<img src="{{ "/images/20160331-NoisyInput-200x275.png" | prepend: site.baseurl }}" id="Fig9.3-1">
...
<img src="{{ "/images/20160331-MAP-800x652.png" | prepend: site.baseurl }}" id="Fig9.4-1">
...
<img src="{{ "/images/20160331-MCMC-300x271.png" | prepend: site.baseurl }}" id="Fig9.4-2">
...
<img src="{{ "/images/20160331-Dropout-200x184.png" | prepend: site.baseurl }}" id="Fig10.3-1">
